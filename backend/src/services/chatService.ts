...
Δεν βρέθηκαν σχετικές πληροφορίες για αυτήν την ερώτηση.`;
  ...
  // ── Κανόνες απάντησης ──────────────────────────────────────────────────────
  const rules = `ΚΑΝΟΝΕΣ:
- Απάντα με βάση τις παραπάνω πληροφορίες από τη γνωσιακή βάση
- Αν υπάρχουν ΔΙΟΡΘΩΣΕΙΣ παρακάτω (ενότητα "ΥΠΟΧΡΕΩΤΙΚΕΣ ΔΙΟΡΘΩΣΕΙΣ"), αυτές έχουν ΑΠΟΛΥΤΗ ΠΡΟΤΕΡΑΙΟΤΗΤΑ και ΑΝΤΙΚΑΘΙΣΤΟΥΝ τη γνωσιακή βάση — χρησιμοποίησε ΠΑΝΤΑ τη διορθωμένη πληροφορία
